...
def get_columns():
	columns = [
		...
		{"label": _("Design No"), "fieldname": "design_no", "fieldtype": "Data","width": 110},
		...
		{"label": _("Party Code"), "fieldname": "party_code", "fieldtype": "Link", "options": "Supplier", "width": 110},
		{"label": _("Party Name"), "fieldname": "party_name", "fieldtype": "Data", "width": 110},
		{"label": _("Quality Code"), "fieldname": "quality_code", "fieldtype": "Link", "options": "PM Quality", "width": 110},
		{"label": _("Quality Name"), "fieldname": "quality_name", "fieldtype": "Data", "width": 110}
	]
	return columns
...
def get_sle_conditions(filters):
	...
	if filters.get("batch_no"):
		conditions.append("batch_no like %(batch_no)s")
	if filters.get("design_no"):
		conditions.append("design_no like %(design_no)s")
